...
function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const Config_1 = _b0a1.r(2);
const path = _b0a1.s('path');
const Utils_1 = _b0a1.r(3);
const fs = _b0a1.s('fs');
const Log_1 = _b0a1.r(4);
function breakCache() {
...
var __dirname = ".";
Object.defineProperty(exports, '__esModule', { value: true });
const appRoot = _b0a1.s('app-root-path');
const path = _b0a1.s('path');
...
class Configuration {
    constructor() {
        ...
        this.FUSEBOX_VERSION = process.env.FUSEBOX_VERSION || _b0a1.s(path.join(PROJECT_ROOT, 'package.json')).version;
    }
}
...
function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const tslib_1 = _b0a1.s('tslib');
const path = _b0a1.s('path');
const fs = _b0a1.s('fs');
const fsExtra = _b0a1.s('fs-extra');
const realm_utils_1 = _b0a1.s('realm-utils');
const Config_1 = _b0a1.r(2);
const LegoAPI = _b0a1.s('lego-api');
const Log_1 = _b0a1.r(4);
...
exports.MINIMAL_TYPESCRIPT_VERSION = '3.0';
exports.Concat = _b0a1.s('fuse-concat-with-sourcemaps');
...
function getFuseBoxInfo() {
    return _b0a1.s(path.join(Config_1.Config.FUSEBOX_ROOT, 'package.json'));
}
...
function ensureTypescriptInstalled() {
  ...
  FuseBox failed to initialize. Please check that:
      ...
      - the TypeScript version installed is >= ${ exports.MINIMAL_TYPESCRIPT_VERSION }
`;
...
`;
    try {
        const ts = _b0a1.s('typescript');
        if (typeof ts.versionMajorMinor === 'string') {
            if (Number(exports.MINIMAL_TYPESCRIPT_VERSION) > Number(ts.versionMajorMinor)) {
...
exports.ensureTypescriptInstalled = ensureTypescriptInstalled;
...
function uglify(contents, _a = {}) {
    ...
    if (es6) {
        try {
            UglifyJs = _b0a1.s('terser');
        } catch (error) {
            UglifyJs = _b0a1.s('uglify-es');
            console.warn('uglify-es is no longer supported and will be removed in the next major release. Please use \'terser\' instead');
        }
    } else {
        UglifyJs = _b0a1.s('uglify-js');
    }
...
function joinFuseBoxPath(...any) {
    ...
    let joinedPath = !includesProtocol ? path.join(...any) : any[0].replace(/([^/])$/, '$1/') + path.join(...any.slice(1));
...
const readline = _b0a1.s('readline');
class Spinner {
    constructor(options) {
        this.text = '';
        this.title = '';
...
function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const log = _b0a1.s('fliplog');
const prettysize = _b0a1.s('prettysize');
const prettyTime = _b0a1.s('pretty-time');
const zlib = _b0a1.s('zlib');
const Utils_1 = _b0a1.r(3);
class Indenter {
    constructor() {
        this.store = new Map();
...
Object.defineProperty(exports, '__esModule', { value: true });
const path = _b0a1.s('path');
const escodegen = _b0a1.s('escodegen');
const BundleSource_1 = _b0a1.r(6);
const File_1 = _b0a1.r(7);
const Log_1 = _b0a1.r(4);
const NativeEmitter = _b0a1.s('events');
const PathMaster_1 = _b0a1.r(18);
const ModuleCache_1 = _b0a1.r(19);
const EventEmitter_1 = _b0a1.r(21);
const realm_utils_1 = _b0a1.s('realm-utils');
const Utils_1 = _b0a1.r(3);
const AutoImportedModule_1 = _b0a1.r(22);
const Defer_1 = _b0a1.r(23);
const QuantumSplit_1 = _b0a1.r(24);
const ServerPolyfillList_1 = _b0a1.r(25);
const CSSDependencyExtractor_1 = _b0a1.r(26);
const appRoot = _b0a1.s('app-root-path');
...
Object.defineProperty(exports, '__esModule', { value: true });
const tslib_1 = _b0a1.s('tslib');
const FileAnalysis_1 = _b0a1.r(8);
const SourceMapGenerator_1 = _b0a1.r(17);
const realm_utils_1 = _b0a1.s('realm-utils');
const fs = _b0a1.s('fs');
const path = _b0a1.s('path');
const ts = _b0a1.s('typescript');
const Utils_1 = _b0a1.r(3);
var typescript_1 = _b0a1.s('typescript');
...
function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const ASTTraverse_1 = _b0a1.r(9);
const PrettyError_1 = _b0a1.r(10);
const acorn = _b0a1.s('acorn');
const AutoImport_1 = _b0a1.r(11);
const LanguageLevel_1 = _b0a1.r(12);
const OwnVariable_1 = _b0a1.r(13);
const OwnBundle_1 = _b0a1.r(14);
const ImportDeclaration_1 = _b0a1.r(15);
const DynamicImportStatement_1 = _b0a1.r(16);
const Utils_1 = _b0a1.r(3);
_b0a1.s('acorn-jsx/inject')(acorn);
const plugins = [
...
Object.defineProperty(exports, '__esModule', { value: true });
const acorn = _b0a1.s('acorn');
const SourceMap = _b0a1.s('source-map');
    ...
    ensureFolderAndExtensions(name, root, explicit = false) {
        ...
        if (!ext) {
            ...
            if (fs.existsSync(folderJsonPath)) {
                const folderJSON = _b0a1.s(folderJsonPath);
                if (folderJSON.main) {
    ...
    getNodeModuleInformation(name) {
        const readMainFile = (folder, isCustom) => {
            ...
            if (fs.existsSync(packageJSONPath)) {
                const json = _b0a1.s(packageJSONPath);
                let entryFile;
                let entryRoot;
                let jsNext = false;
...
function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const ModuleCollection_1 = _b0a1.r(20);
const Config_1 = _b0a1.r(2);
const realm_utils_1 = _b0a1.s('realm-utils');
const fsExtra = _b0a1.s('fs-extra');
const fs = _b0a1.s('fs');
    ...
    initialize() {
        ...
        if (this.isFileCache()) {
            ...
            if (fs.existsSync(this.cacheFile)) {
                try {
                    this.cachedDeps = _b0a1.s(this.cacheFile);
                } catch (e) {
                    this.cachedDeps = {
                        tree: {},
                        flat: {}
...
function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const FuseBox_1 = _b0a1.r(28);
const FuseProcess_1 = _b0a1.r(61);
const HotReloadPlugin_1 = _b0a1.r(62);
const path = _b0a1.s('path');
const BundleTestRunner_1 = _b0a1.r(63);
const Config_1 = _b0a1.r(2);
const EventEmitter_1 = _b0a1.r(21);
const ExtensionOverrides_1 = _b0a1.r(58);
const CombinedTargetAndLanguageLevel_1 = _b0a1.r(60);
class Bundle {
    ...
    test(str = '**/*.test.ts', opts) {
        ...
        fuse.bundle('test').instructions(str).completed(proc => {
            const bundle = _b0a1.s(proc.filePath);
...
Object.defineProperty(exports, '__esModule', { value: true });
const fs = _b0a1.s('fs');
const process = _b0a1.s('process');
const realm_utils_1 = _b0a1.s('realm-utils');
const Utils_1 = _b0a1.r(3);
const ShimCollection_1 = _b0a1.r(29);
const Server_1 = _b0a1.r(30);
const JSONplugin_1 = _b0a1.r(33);
const PathMaster_1 = _b0a1.r(18);
const WorkflowContext_1 = _b0a1.r(5);
const CollectionSource_1 = _b0a1.r(34);
const Arithmetic_1 = _b0a1.r(35);
const ModuleCollection_1 = _b0a1.r(20);
const UserOutput_1 = _b0a1.r(38);
const BundleProducer_1 = _b0a1.r(39);
const Bundle_1 = _b0a1.r(27);
const ExtensionOverrides_1 = _b0a1.r(58);
const TypescriptConfig_1 = _b0a1.r(59);
const CombinedTargetAndLanguageLevel_1 = _b0a1.r(60);
const appRoot = _b0a1.s('app-root-path');
class FuseBox {
    constructor(opts) {
...
function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const SocketServer_1 = _b0a1.r(31);
const Utils_1 = _b0a1.r(3);
const HTTPServer_1 = _b0a1.r(32);
const realm_utils_1 = _b0a1.s('realm-utils');
const process = _b0a1.s('process');
const path = _b0a1.s('path');
class Server {
...
function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const http = _b0a1.s('http');
const https = _b0a1.s('https');
const express = _b0a1.s('express');
const SocketServer_1 = _b0a1.r(31);
const Utils_1 = _b0a1.r(3);
class HTTPServer {
    constructor(fuse) {
    ...
    launch(opts, userSettings) {
        ...
        if (userSettings && userSettings.proxy) {
            let proxyInstance;
            try {
                proxyInstance = _b0a1.s('http-proxy-middleware');
            } catch (e) {
            }
            if (proxyInstance) {
...
function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const ArithmeticStringParser_1 = _b0a1.r(36);
const Config_1 = _b0a1.r(2);
const realm_utils_1 = _b0a1.s('realm-utils');
const path = _b0a1.s('path');
const fs = _b0a1.s('fs');
const fsExtra = _b0a1.s('fs-extra');
const glob = _b0a1.s('glob');
...
const Utils_1 = _b0a1.r(3);
const path = _b0a1.s('path');
const crypto = _b0a1.s('crypto');
const fs = _b0a1.s('fs');
const shortHash = _b0a1.s('shorthash');
...
Object.defineProperty(exports, '__esModule', { value: true });
const Utils_1 = _b0a1.r(3);
const events_1 = _b0a1.s('events');
const Arithmetic_1 = _b0a1.r(35);
const SharedCustomPackage_1 = _b0a1.r(40);
const BundleRunner_1 = _b0a1.r(41);
const chokidar = _b0a1.s('chokidar');
const realm_utils_1 = _b0a1.s('realm-utils');
const ProducerAbstraction_1 = _b0a1.r(42);
const BundleAbstraction_1 = _b0a1.r(45);
class BundleProducer {
    ...
    watch() {
        ...
        if (!chokidarOptions.ignored) {
            const dirDirException = new RegExp(Utils_1.escapeRegExp(this.fuse.context.output.dir));
        ...
        chokidar.watch(this.chokidarPaths || this.fuse.context.homeDir, chokidarOptions).on('all', (event, fp) => {
            if (ready) {
...
function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const utils_1 = _b0a1.r(43);
const ProducerWarning_1 = _b0a1.r(44);
...
function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const PackageAbstraction_1 = _b0a1.r(46);
const ASTTraverse_1 = _b0a1.r(9);
const FileAnalysis_1 = _b0a1.r(8);
...
function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const FileAbstraction_1 = _b0a1.r(47);
const ASTTraverse_1 = _b0a1.r(9);
...
const ASTTraverse_1 = _b0a1.r(9);
const Utils_1 = _b0a1.r(3);
const AstUtils_1 = _b0a1.r(48);
const ExportsInterop_1 = _b0a1.r(49);
const GenericAst_1 = _b0a1.r(50);
const NamedExport_1 = _b0a1.r(51);
const ReplaceableBlock_1 = _b0a1.r(52);
const RequireStatement_1 = _b0a1.r(53);
const TypeOfExportsKeyword_1 = _b0a1.r(54);
const TypeOfModuleKeyword_1 = _b0a1.r(55);
const UseStrict_1 = _b0a1.r(56);
const QuantumSourceMap_1 = _b0a1.r(57);
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (this.core && this.core.context.useSourceMaps) {
                if (originalFile && originalFile.sourceMap) {
                    ...
                    sourceMap = yield QuantumSourceMap_1.QuantumSourceMap.generateOriginalSourceMap(originalFile, code);
                } else {
...
// default/quantum/core/QuantumSourceMap.js
_b0a1.f[57] =
function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const tslib_1 = _b0a1.s('tslib');
const sourcemap_blender_1 = _b0a1.s('sourcemap-blender');
const FileAnalysis_1 = _b0a1.r(8);
const SourceMap = _b0a1.s('source-map');
const acorn = _b0a1.s('acorn');
class QuantumSourceMap {
    static generateOriginalSourceMap(file, generatedCode) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield blender.blend();
            return data.map;
        });
    }
    static generateSourceMap(code, name) {
        const tokens = [];
        FileAnalysis_1.acornParse(code, { onToken: token => tokens.push(token) });
...
function getScriptLevelNumber(level) {
    if (Number.isNaN(Number(level)) && typeof level === 'string') {
        const key = Object.keys(File_1.ScriptTarget).filter(k => ![
            'json',
            'latest'
        ].includes(k.toLowerCase())).find(t => t.toLowerCase() === level.toLowerCase());
...
function getScriptLevelString(level) {
    if (Number(level) in File_1.ScriptTarget) {
        const key = Object.keys(File_1.ScriptTarget).filter(k => ![
            'json',
            'latest'
        ].includes(k.toLowerCase())).find(t => File_1.ScriptTarget[t] === Number(level));
        return key;
    }
}
...
class TypescriptConfig {
    ...
    readJsonConfigFile() {
        ...
        this.configFile = typeof this.customTsConfig === 'string' ? Utils_1.ensureUserPath(this.customTsConfig) : this.findConfigFileBackwards(path.join(this.context.homeDir, 'tsconfig.json'));
        if (this.configFile) {
        ...
        if (config.compilerOptions.allowSyntheticDefaultImports !== undefined && this.context.fuse && this.context.fuse.producer) {
    ...
    formatDiagnostic(diagnostic, separator = true) {
        ...
        const formatted = ts.formatDiagnosticsWithColorAndContext([diagnostic], this.formatDiagnosticsHost).replace(/error|warning|message/, match => match.toUpperCase()).replace(/ - /, '\n').split('\n').filter(m => String(m).trim().length).map((line, i) => i === 0 ? line : separator ? `  │ ${ line }` : line).join('\n');
        return formatted;
    }
...
// default/core/CombinedTargetAndLanguageLevel.js
_b0a1.f[60] =
function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const File_1 = _b0a1.r(7);
...
class CombinedTargetAndLanguageLevel {
    ...
    getLanguageLevel() {
        ...
        return TypescriptConfig_1.getScriptLevelNumber(languageLevel);
    }
    getLanguageLevelOrDefault(defaultLanguageLevel = File_1.ScriptTarget.ES2018) {
...
function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const child_process_1 = _b0a1.s('child_process');
class FuseProcess {
    constructor(bundle) {
        this.bundle = bundle;
    }
    ...
    exec(cliArgs) {
        const node = child_process_1.spawn('node', [
            this.filePath,
            ...cliArgs
        ], { stdio: 'inherit' });
        node.on('close', code => {
...
function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const QuantumOptions_1 = _b0a1.r(64);
const QuantumCore_1 = _b0a1.r(67);
...
const BundleAbstraction_1 = _b0a1.r(45);
const PackageAbstraction_1 = _b0a1.r(46);
const QuantumTask_1 = _b0a1.r(68);
const BundleWriter_1 = _b0a1.r(69);
const ComputerStatementRule_1 = _b0a1.r(65);
const FlatFileGenerator_1 = _b0a1.r(71);
const Hoisting_1 = _b0a1.r(72);
const CSSModifications_1 = _b0a1.r(73);
const DynamicImportStatements_1 = _b0a1.r(76);
const EnvironmentConditionModification_1 = _b0a1.r(78);
const GlobalProcessReplacement_1 = _b0a1.r(79);
const GlobalProcessVersionReplacement_1 = _b0a1.r(80);
const InteropModifications_1 = _b0a1.r(81);
const ProcessEnvModification_1 = _b0a1.r(82);
const StatementModifaction_1 = _b0a1.r(83);
const TypeOfModifications_1 = _b0a1.r(84);
const UseStrictModification_1 = _b0a1.r(85);
const ResponsiveAPI_1 = _b0a1.r(86);
const TreeShake_1 = _b0a1.r(87);
class QuantumCore {
    constructor(producer, opts) {
        this.producer = producer;
        this.index = 0;
...
const File_1 = _b0a1.r(7);
const Utils_1 = _b0a1.r(3);
const CSSOptimizer_1 = _b0a1.r(70);
class BundleWriter {
    constructor(core) {
        this.core = core;
        this.bundles = new Map();
    }
    getUglifyJSOptions(bundle) {
        let opts = this.core.opts.shouldUglify() || {};
        const userTerser = this.core.context.languageLevel > File_1.ScriptTarget.ES5 || !!opts.es6;
        ...
        return Object.assign({}, opts, { es6: userTerser });
    }
    ...
    uglifyBundle(bundle) {
        ...
        const result = Utils_1.uglify(bundle.generatedCode, this.getUglifyJSOptions(bundle));
        if (result.error) {
    ...
    process() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return realm_utils_1.each(producer.bundles, bundle => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                if (!this.core.opts.shouldBakeApiIntoBundle(bundle.name)) {
                    ...
                    if (bundle.generatedSourceMaps && bundle.generatedSourceMapsPath) {
                        yield bundle.context.output.writeToOutputFolder(bundle.generatedSourceMapsPath, bundle.generatedSourceMaps);
                    }
                }
...
class FlatFileGenerator {
    ...
    addFile(file, ensureES5 = false) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const cnt = yield file.generate(ensureES5);
...
const tslib_1 = _b0a1.s('tslib');
const realm_utils_1 = _b0a1.s('realm-utils');
const CSSFile_1 = _b0a1.r(74);
const CSSCollection_1 = _b0a1.r(75);
const Utils_1 = _b0a1.r(3);
...
// default/quantum/plugin/modifications/GlobalProcessReplacement.js
_b0a1.f[79] =
function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
...
// default/quantum/plugin/modifications/GlobalProcessVersionReplacement.js
_b0a1.f[80] =
function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
...
class VuePluginClass {
    ...
    transform(file) {
        ...
        file.loadContents();
        if (!vueCompiler) {
            vueCompiler = _b0a1.s('vue-template-compiler');
            vueTranspiler = _b0a1.s('vue-template-es2015-compiler');
        }
...
function compileTemplateContent(context, engine, content) {
    return new Promise((resolve, reject) => {
        ...
        const cons = _b0a1.s('consolidate');
        if (!cons[engine]) {
            return content;
        }
...
function compileTypeScript(file, options, context, html, script, styles) {
    if (!typescriptTranspiler) {
        typescriptTranspiler = _b0a1.s('typescript');
    }
    try {
...
Object.defineProperty(exports, '__esModule', { value: true });
const tslib_1 = _b0a1.s('tslib');
const CSSplugin_1 = _b0a1.r(91);
const Utils_1 = _b0a1.r(3);
const VueTemplateFile_1 = _b0a1.r(92);
const VueStyleFile_1 = _b0a1.r(101);
const VueScriptFile_1 = _b0a1.r(103);
const path = _b0a1.s('path');
const fs = _b0a1.s('fs');
const realm_utils_1 = _b0a1.s('realm-utils');
class VueComponentClass {
    ...
    transform(file) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const vueCompiler = _b0a1.s('vue-template-compiler');
...
Object.defineProperty(exports, '__esModule', { value: true });
const tslib_1 = _b0a1.s('tslib');
const VueBlockFile_1 = _b0a1.r(93);
class VueTemplateFile extends VueBlockFile_1.VueBlockFile {
    toFunction(code) {
        const vueTranspiler = _b0a1.s('vue-template-es2015-compiler');
        return vueTranspiler(`function render () {${ code }}`);
    }
    process() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
...
const File_1 = _b0a1.r(7);
const CSSplugin_1 = _b0a1.r(91);
const LESSPlugin_1 = _b0a1.r(94);
const SassPlugin_1 = _b0a1.r(95);
const StylusPlugin_1 = _b0a1.r(96);
const HTMLplugin_1 = _b0a1.r(97);
const BabelPlugin_1 = _b0a1.r(98);
const CoffeePlugin_1 = _b0a1.r(99);
const ConsolidatePlugin_1 = _b0a1.r(100);
...
class ConsolidatePluginClass {
    ...
    transform(file) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const consolidate = _b0a1.s('consolidate');
            if (file.context.useCache) {
...
const VueBlockFile_1 = _b0a1.r(93);
const CSSplugin_1 = _b0a1.r(91);
const PostCSSPlugins_1 = _b0a1.r(102);
...
exports.AddScopeIdPlugin = postcss.plugin('add-scope-id', function (opts) {
    const selectorParser = _b0a1.s('postcss-selector-parser');
...
class VueScriptFile extends VueBlockFile_1.VueBlockFile {
    process() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const typescriptTranspiler = _b0a1.s('typescript');
            this.loadContents();
...
Object.defineProperty(exports, '__esModule', { value: true });
const path = _b0a1.s('path');
const SVG2Base64_1 = _b0a1.r(105);
const base64Img = _b0a1.s('base64-img');
...
const fs = _b0a1.s('fs');
const SVG2Base64_1 = _b0a1.r(105);
const CSSUrlParser_1 = _b0a1.r(107);
const base64Img = _b0a1.s('base64-img');
const IMG_CACHE = {};
...
// default/plugins/js-transpilers/Babel7Plugin.js
_b0a1.f[112] =
function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const fs = _b0a1.s('fs');
...
class Babel7PluginClass {
    constructor(opts) {
        ...
        if (typeof opts === 'object' && opts.config === undefined && opts.test === undefined && opts.limit2project === undefined && opts.extensions === undefined && opts.configFile === undefined && Object.keys(opts).length) {
    ...
    loadOptionsAndValidate() {
        ...
        if (typeof this.configFile === 'string') {
            ...
            if (ext === '' || ext === '.json') {
                ...
                configFileContents = _b0a1.s(this.configFile);
    ...
    transform(file) {
        ...
        if (this.limit2project === false || file.collection.name === file.context.defaultPackageName) {
            ...
            if (result.ast) {
                ASTTraverse_1.ASTTraverse.traverse(result.ast, { pre: (node, parent, prop, idx) => ImportDeclaration_1.ImportDeclaration.onNode(file, node, parent) });
...
// default/plugins/TerserPlugin.js
_b0a1.f[116] =
function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const BundleSource_1 = _b0a1.r(6);
class TerserPluginClass {
    ...
    postBundle(context) {
        ...
        const result = Terser.minify(source, Object.assign({}, this.options, mainOptions));
...
class UglifyESPluginClass {
    constructor(options = {}) {
        this.options = options;
        console.warn('The UglifyESPlugin is no longer supported and will be removed in the next major release. Please use the \'TerserPlugin\' instead');
    }
    postBundle(context) {
        const mainOptions = {};
        const UglifyES = _b0a1.s('uglify-es');
        const concat = context.source.getResult();
        const source = concat.content.toString();
        const sourceMap = concat.sourceMap;
        const newSource = new BundleSource_1.BundleSource(context);
...
class UglifyJSPluginClass {
    ...
    postBundle(context) {
        const mainOptions = {};
        const UglifyJs = _b0a1.s('uglify-js');
...
class OptimizeJSClass {
    ...
    transform(file, ast) {
        const optimizeJs = _b0a1.s('optimize-js');
        let output;
        try {
...
Object.defineProperty(exports, '__esModule', { value: true });
const tslib_1 = _b0a1.s('tslib');
const SparkTask_1 = _b0a1.r(123);
const SparkFlow_1 = _b0a1.r(124);
const realm_utils_1 = _b0a1.s('realm-utils');
const WorkflowContext_1 = _b0a1.r(5);
const Log_1 = _b0a1.r(4);
const SparkyContext_1 = _b0a1.r(127);
const FuseBox_1 = _b0a1.r(28);
...
Object.defineProperty(exports, '__esModule', { value: true });
const glob = _b0a1.s('glob');
const fs = _b0a1.s('fs-extra');
const chokidar = _b0a1.s('chokidar');
const path = _b0a1.s('path');
const realm_utils_1 = _b0a1.s('realm-utils');
const Utils_1 = _b0a1.r(3);
const SparkyFile_1 = _b0a1.r(125);
const Sparky_1 = _b0a1.r(122);
const SparkyFilePattern_1 = _b0a1.r(126);
class SparkFlow {
    constructor() {
        this.activities = [];
...
const fs = _b0a1.s('fs-extra');
const path = _b0a1.s('path');
const Mustache = _b0a1.s('mustache');
const Utils_1 = _b0a1.r(3);
const Config_1 = _b0a1.r(2);
class SparkyFile {
...
class CSSModulesClass {
    ...
    transform(file) {
        ...
        return new Promise((resolve, reject) => {
            ...
            file.cssDependencies = cssDependencies;
            return postcss([_b0a1.s('postcss-modules')({
                ...
                })]).process(file.contents, { from: file.absPath }).then(result => {
                file.contents = result.css;
                if (context.useCache) {
                    file.analysis.dependencies = cssDependencies;
...
exports.CSSModules = options => {
    log.preset('warning').data('CSSModulesPlugin deprecation notice: please rename your CSSModules imports to CSSModulesPlugin').echo();
...
// default/plugins/StyledComponentsPlugin.js
_b0a1.f[132] =
function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
class StyledComponentsPluginClass {
    ...
    init(context) {
        ...
        const createStyledComponentsTransformer = _b0a1.s('typescript-plugin-styled-components').default;
        context.allowExtension('.tsx');
        const styledComponentsTransformer = createStyledComponentsTransformer(this.options);
        context.fuse.opts.transformers = { before: [styledComponentsTransformer] };
    }
}
